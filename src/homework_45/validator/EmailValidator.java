...
public class EmailValidator {
    ...
    public static void isPasswordValid(String password) throws PasswordValidateException {
        if (!password.matches(VALID_PASSWORD_REGEX)) {
            throw new PasswordValidateException("Invalid password format. Password must contain at least one uppercase letter, one lowercase letter, one digit, one special character, and be at least 8 characters long.");
        }
    }
}